...
if 'model' in st.session_state:
    ...
    model_path = HERE / 'yolov8_cell_detection.pt'
...
def yolov8_cell_detection(frame: av.VideoFrame) -> av.VideoFrame:
...
if __name__ == '__main__':
    ...
    dummy_plugin.register_processor(
        'yolov8 cell detection', yolov8_cell_detection,
    )  # There can be more than one
    run(dummy_plugin, layout="horizontal")